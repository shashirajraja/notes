...
public class D_ExecuteQueryMethod { //See Step-5
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Example2: Using executeQuery method;
			 ...
			 * Use this when the result is a row details or list of row details
			 * 
			 */
			while(rs.next()) { //next method returns if there is any more row in the result set and move the pointer to next row if exists
				int id = rs.getInt(1); //column number starting 1 indexed
