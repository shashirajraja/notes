...
public class E_ExecuteUpdateMethod { // See Step-5
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * 
			 * 1) execute: Returns true if the first object that the query returns is a
			 ...
			 * 
			 * 2) executeQuery: Returns one ResultSet object. //Use this when the result is
			 * a row details or list of row details
			 * 
			 * 3) executeUpdate: Returns an integer representing the number of rows affected
			 * by the SQL statement. Use this method if you are using INSERT, DELETE, or
			 * UPDATE SQL statements.
			 */

			// Example3: Using executeUpdate method;
			// Create table student(id number, name varchar2(20), email varchar2(20), phone
			// number);
			int result = statement
					.executeUpdate("insert into student values(23456,'shashi','shashi@gmail.com',2345678)");
			/*
